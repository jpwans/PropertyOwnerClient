...
#import "VersionNotes.h"


static NSString *const YReleaseNotesViewVersionKey = @"ReleaseNotesVersionKey";
@interface VersionNotes() <NSURLConnectionDelegate>
...
+ (void)storeCurrentAppVersionString
{
    ...
    [[NSUserDefaults standardUserDefaults] setObject:currentAppVersion forKey:YReleaseNotesViewVersionKey];
...
+ (BOOL)isAppOnFirstLaunch
{
    ...
    NSString *previousAppVersion = [[NSUserDefaults standardUserDefaults] stringForKey:YReleaseNotesViewVersionKey];
...
+(void)getTheLatestVersionInformationWithAppIdentifier:(NSString *)appIdentifier completionBlock:(CompletionBlock)completionBlock completionBlockError:(CompletionBlockError)completionBlockError{
    ...
    VersionNotes *versionNotesOperation = [[VersionNotes alloc]init];
    ...
    __block VersionNotes *weakOperation = versionNotesOperation;
